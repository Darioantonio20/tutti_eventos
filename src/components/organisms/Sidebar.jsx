...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const menuItems = [
        { label: 'Dashboard', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>, path: '/dashboard' },
        ...
        { label: 'Mis Eventos', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>, path: '/mis-eventos' },
        { label: 'Mensajes', icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>, path: '/mensajes' },
    ];
      ...
      `}>
                <div className="flex flex-col h-full">
                    ...
                    <div
                        ...
                        className="p-6 border-t border-slate-50 flex items-center gap-4 cursor-pointer hover:bg-slate-50 transition-colors group"
                    >
                        <div className="w-10 h-10 rounded-full bg-slate-100 border-2 border-white shadow-sm flex items-center justify-center text-sm font-bold text-slate-500 overflow-hidden group-hover:border-brand-primary transition-colors">
                            DL
                        </div>
                        <div className="flex flex-col">
                            <span className="text-xs font-black text-slate-800 leading-none group-hover:text-brand-primary transition-colors">Dario Lopez</span>
                            <span className="text-[9px] font-bold text-brand-primary uppercase tracking-widest mt-1">Usuario Premium</span>
                        </div>
                        <button className="ml-auto text-slate-300 hover:text-red-500 transition-colors" title="Cerrar Sesión" onClick={(e) => { e.stopPropagation(); /* Add logout logic here */ }}>
